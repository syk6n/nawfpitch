      ...
      <div className="relative w-full max-w-5xl mx-auto px-4 flex items-center justify-center" style={{ height: '60vh', minHeight: '500px' }}>
        ...
        >
          <span
            ...
            style={{ fontFamily: "'Inter', sans-serif", textShadow: '0 4px 30px rgba(0,0,0,0.5)' }}
          >
            {'NAWF'.split('').map((letter, i) => (
              <span
                key={i}
                className="nawf-letter inline-block will-change-transform transition-colors duration-200"
              >
                {letter}
              </span>
            ))}
